            ...
            <dl>
                ...
                <dd>
                    ...
                    <div class="viewlist mt10">
                        <h3>最近浏览的商品：</h3>
                        <ul>
                            <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/view_list1.jpg')?></a></li>
                            <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/view_list2.jpg')?></a></li>
                            <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/view_list3.jpg')?></a></li>
                        </ul>
                    </div>
                </dd>
            </dl>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><?=\yii\helpers\Html::a($category->name,['shouye/list','cate_id'=>$category->id])?><b></b></h3>
                    <?php foreach($category->children as $child):?>
                    <div class="cat_detail">

                        <dl class="dl_1st">
                            <dt><?=\yii\helpers\Html::a($child->name,['shouye/list','cate_id'=>$child->id])?></dt>
                            <dd>
                                <?php foreach($child->children as $cate):?>
                                    <?=\yii\helpers\Html::a($cate->name,['shouye/list','cate_id'=>$cate->id])?>
                                <?php endforeach;?>
                            </dd>
                        </dl>
...
<div class="colligate w1210 bc mt10">
    ...
    <div class="coll_right fl ml10">
        <div class="ad"><a href=""><?=\yii\helpers\Html::img('@web/images/index_slide6.jpg')?></a></div>
...
<div class="floor1 floor w1210 bc mt10">
            ...
            <div class="goodslist_wrap">
                ...
                <div class="none">
                    <ul>
                        <li>
                            <dl>
                                <dt><a href=""><?=\yii\helpers\Html::img('@web/images/hpG4.jpg.jpg')?></a></dt>
                                <dd><a href="">惠普G4-1332TX 14英寸笔</a></dd>
                                <dd><span>售价：</span> <strong>￥2999.00</strong></dd>
                            </dl>
                        </li>
    ...
    <div class="sidebar fl ml10">
        ...
        <div class="brand">
            ...
            <div class="sidebar_wrap">
                <ul>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/dell.gif')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/acer.gif')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/fujitsu.jpg')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/hp.jpg')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/lenove.jpg')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/samsung.gif')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/dlink.gif')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/seagate.jpg')?></a></li>
                    <li><a href=""><a href="index.html"><?=\yii\helpers\Html::img('@web/images/intel.jpg')?></a></li>
                </ul>
            </div>
        </div>
        <!-- 品牌旗舰店 end -->
